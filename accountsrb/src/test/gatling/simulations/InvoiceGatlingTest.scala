...
class InvoiceGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Invoice entity")
        ...
        .repeat(2) {
            ...
            .post("/api/invoices")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "creationDate":"2020-01-01T00:00:00.000Z", "modficationDate":"2020-01-01T00:00:00.000Z", "invoiceNumber":"SAMPLE_TEXT", "orderNumber":"SAMPLE_TEXT", "salesPersonName":"SAMPLE_TEXT", "subtotal":null, "taxes":null, "shippingCharges":null, "adjustments":null, "totalAmount":null}""")).asJSON
            .check(status.is(201))
