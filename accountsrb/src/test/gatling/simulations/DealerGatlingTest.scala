...
class DealerGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Dealer entity")
        ...
        .repeat(2) {
            ...
            .post("/api/dealers")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "creationDate":"2020-01-01T00:00:00.000Z", "modificationDate":"2020-01-01T00:00:00.000Z", "firmName":"SAMPLE_TEXT", "ownerName":"SAMPLE_TEXT", "tin":"SAMPLE_TEXT", "termsAndConditions":"SAMPLE_TEXT", "openingBalance":null, "currentBalance":null}""")).asJSON
            .check(status.is(201))
